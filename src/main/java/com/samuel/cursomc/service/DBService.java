...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Produto p8 = new Produto(null, "Roçadeira", 700.00);
		Produto p9 = new Produto(null, "Pendente", 100.00);
		Produto p10 = new Produto(null, "Abajour", 200.00);
		...
		cat5.getProdutos().addAll(Arrays.asList(p9, p10, p7, p8));
		...
		p6.getCategorias().addAll(Arrays.asList(cat4, cat6));
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "samuel.teles.loko@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("46584664", "161651616"));
